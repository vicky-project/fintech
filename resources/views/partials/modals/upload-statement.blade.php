      ...
      <div class="modal-body">
        <form id="uploadStatementForm">
          ...
          <div class="mb-3">
            ...
            <input type="file" class="form-control" name="file" accept=".csv,.pdf,.xls,.xlsx,application/vnd.ms-excel,application/vnd.openxmlformats-officedocument.spreadsheetml.sheet,text/csv,text/comma-separated-values,application/csv" required>
