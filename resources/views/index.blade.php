...
<script>
  ...
  function renderDashboard() {
    ...
    container.innerHTML = '<p class="text-muted text-center">Belum ada kategori</p>';
    return;
    }
    let html = '<div class="list-group">';
    ...
    <div class="d-flex align-items-center">
    <div class="me-3">
    <i class="${cat.icon || 'bi-tag'} fs-4" style="color: ${cat.color || '#6c757d'}"></i>
    </div>
    <div>
    ...
    return currency?.symbol || code?.symbol || code;
    }
